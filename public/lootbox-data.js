...
window.LOOTBOX = {
  ...
  prizes: [
    ...
    { id:"taipei_instrumental", label:"Yung Lean – Taipei Instrumental", weight:55, type:"music_unlock", key:"taipei_instrumental" },
    { id:"bg_vegas", label:"Background: Las Vegas Skyline", weight:45, type:"background_unlock", key:"vegas_skyline" },
    { id:"bg_roulette", label:"Background: Trippy Roulette", weight:45, type:"background_unlock", key:"trippy_roulette" },
    { id:"bg_oldppl", label:"Background: Old People Slot", weight:45, type:"background_unlock", key:"old_ppl_slot" },
    { id:"bg_taipei_night", label:"Background: Taipei Nightlife (Video)", weight:40, type:"background_unlock", key:"taipei_nightlife" },
